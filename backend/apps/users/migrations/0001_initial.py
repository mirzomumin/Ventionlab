    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Record creation time')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Time of record change')),
                ('role', models.PositiveSmallIntegerField(choices=[(1, 'Student'), (2, 'Mentor')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='internships', to='courses.course')),
                ('participants', models.ManyToManyField(blank=True, related_name='internships', to='users.internshipparticipant')),
            ],
            options={
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(check=models.Q(('start_date__gt', models.F('end_date')), _negated=True), name='end_date_checker', violation_error_message='End date cannot be early than start date.'),
        ),
    ]
